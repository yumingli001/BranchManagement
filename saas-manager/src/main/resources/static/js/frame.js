    ...
    var data = [
        ...
        },
        {
            ...
            children: [
                ...
                {id: '005', level: 2, icon: '', title: '规定管理', path: '/home/page01', children: []},
                {id: '006', level: 2, icon: '', title: '术语管理', path: 'home/page02', children: []},
                {id: '007', level: 2, icon: '', title: '程序管理', path: '/home/page01', children: []},
                {id: '008', level: 2, icon: '', title: '附件管理', path: '/home/page02', children: []},
                {id: '009', level: 2, icon: '', title: '作废审批', path: '/home/page01', children: []},
                {id: '010', level: 2, icon: '', title: '岗位说明书管理', path: 'home/page02', children: []}
            ]
        },
        {
            id: '011',
